...
{
    public class T_ListingDescriptionTemplateMap : EntityTypeConfiguration<T_ListingDescriptionTemplate>
    {
        public T_ListingDescriptionTemplateMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("T_ListingDescriptionTemplate");
