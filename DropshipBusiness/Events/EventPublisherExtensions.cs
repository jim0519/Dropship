...
namespace DropshipBusiness.Events
{
    public static class EventPublisherExtensions
    {
        ...
        public static void ListingPriceUpdated<T>(this IEventPublisher eventPublisher, T entity) where T : BaseEntity
        {
            eventPublisher.Publish(new ListingPriceUpdated<T>(entity));
        }

        public static void ListingPostageRuleUpdated<T>(this IEventPublisher eventPublisher, T entity) where T : BaseEntity
        {
            eventPublisher.Publish(new ListingPostageRuleUpdated<T>(entity));
        }
    }
}